...
import foo.controller.TestController;

/**
 * @author shangkun.liusk
 */
public class ControllerScanBeanDefinitionParserTest extends AbstractTest {

    @Test
    public void testScanController() throws IOException {
        Assert.assertNotNull(this.getBean(TestController.class.getName()));
    }
